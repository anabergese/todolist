  ...
  return (
    <div className="description">
      ...
      <ul>
        <li>
          <strong>
            To bouild this feature I follow interational recomendations:
          </strong>
        </li>
        <li>
          Google Material guidelines, components, and tools that support the
          best practices of user interface design: https://material.io/
        </li>
        <li>
      ...
      <ul>
        <li>
          <strong>Some considerations applied:</strong>
        </li>
      ...
      <p>
        <a
          href="https://icons8.com/icon/61195/todo-list"
          target="_blank"
          rel="noopener noreferrer"
        >
          Todo List icon by Icons8
        </a>
      </p>
    </div>
  );
